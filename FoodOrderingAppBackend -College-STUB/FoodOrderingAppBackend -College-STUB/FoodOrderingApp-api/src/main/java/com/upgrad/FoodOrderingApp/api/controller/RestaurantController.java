...
public class RestaurantController {
    ...
    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.RestaurantService restaurantService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.AddressService addressService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.StateService stateService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.RestaurantCategoryService restaurantCategoryService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.CategoryService categoryService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.CategoryItemService categoryItemService;

    @Autowired
    private com.upgrad.FoodOrderingApp.service.businness.ItemService itemService;
